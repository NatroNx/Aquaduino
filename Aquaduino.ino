   ...
   if (myTouch.dataAvailable())//read x,y when button is touched
    ...
    { myTouch.read();
     ...
     case 46:  //listen on lightscene6
        ...
        if ((lightPWM[lightScreenSet].Hour>=23)&&(lightPWM[lightScreenSet].Hour<=250)){lightPWM[lightScreenSet].Hour=0;}
        else {lightPWM[lightScreenSet].Hour++;}
         UpdateLightScene();
        }
        ...
        if (lightPWM[lightScreenSet].Hour>=230){lightPWM[lightScreenSet].Hour=23;}
        UpdateLightScene();
        }
        ...
        if ((lightPWM[lightScreenSet].Minute>=59)&&(lightPWM[lightScreenSet].Minute<=250)){lightPWM[lightScreenSet].Minute=0;}
        else {lightPWM[lightScreenSet].Minute++;}
         UpdateLightScene();
        }
        ...
        if (lightPWM[lightScreenSet].Minute>=230){lightPWM[lightScreenSet].Minute=59;}
        UpdateLightScene();
        }
        ...
        if ((lightPWM[lightScreenSet+1].Hour>=23)&&(lightPWM[lightScreenSet+1].Hour<=250)){lightPWM[lightScreenSet+1].Hour=0;}
        else {lightPWM[lightScreenSet+1].Hour++;}
         UpdateLightScene();
        }
        ...
        if (lightPWM[lightScreenSet+1].Hour>=230){lightPWM[lightScreenSet+1].Hour=23;}
        UpdateLightScene();
        }
        ...
        if ((lightPWM[lightScreenSet+1].Minute>=59)&&(lightPWM[lightScreenSet+1].Minute<=250)){lightPWM[lightScreenSet+1].Minute=0;}
        else {lightPWM[lightScreenSet+1].Minute++;}
         UpdateLightScene();
        }
        ...
        if (lightPWM[lightScreenSet+1].Minute>=230){lightPWM[lightScreenSet+1].Minute=59;}
        UpdateLightScene();
        }
	  ...
	  cleanFilter2Days=(now.unixtime()-cleanFilter2.unixtime())/86400;
        ...
        {waitForIt(powCo2OnHourUp[0], powCo2OnHourUp[1], powCo2OnHourUp[2], powCo2OnHourUp[3]);
        if ((doseHour>=23)&&(doseHour<=250)){doseHour=0;}
        else {doseHour++;}
         updateDoseScreen();
        }
        else if (((x>=powCo2OnHourDown[0]) && (x<=powCo2OnHourDown[2]))  && ((y>=powCo2OnHourDown[1]) && (y<=powCo2OnHourDown[3]))) // homebutton
        {waitForIt(powCo2OnHourDown[0], powCo2OnHourDown[1], powCo2OnHourDown[2], powCo2OnHourDown[3]);
        doseHour--;
        if (doseHour>=230){doseHour=23;}
        updateDoseScreen();
        }
         else if (((x>=powCo2OnMinuteUp[0]) && (x<=powCo2OnMinuteUp[2]))  && ((y>=powCo2OnMinuteUp[1]) && (y<=powCo2OnMinuteUp[3]))) // homebutton
        {waitForIt(powCo2OnMinuteUp[0], powCo2OnMinuteUp[1], powCo2OnMinuteUp[2], powCo2OnMinuteUp[3]);
        if ((doseMinute>=59)&&(doseMinute<=250)){doseMinute=0;}
        else {doseMinute++;}
         updateDoseScreen();
        }
        else if (((x>=powCo2OnMinuteDown[0]) && (x<=powCo2OnMinuteDown[2]))  && ((y>=powCo2OnMinuteDown[1]) && (y<=powCo2OnMinuteDown[3]))) // homebutton
        {waitForIt(powCo2OnMinuteDown[0], powCo2OnMinuteDown[1], powCo2OnMinuteDown[2], powCo2OnMinuteDown[3]);
        doseMinute--;
        if (doseMinute>=230){doseMinute=59;}
        updateDoseScreen();
        }
 ...
 */        
        ...
        {waitForIt(powLightOnHourUp[0], powLightOnHourUp[1], powLightOnHourUp[2], powLightOnHourUp[3]);
        if ((powLightOnHour>=23)&&(powLightOnHour<=250)){powLightOnHour=0;}
        else {powLightOnHour++;}
        ...
        {waitForIt(powLightOnHourDown[0], powLightOnHourDown[1], powLightOnHourDown[2], powLightOnHourDown[3]);
        powLightOnHour--;
        if (powLightOnHour>=230){powLightOnHour=23;}
        UpdatePowerSchedScreen();
        }
         else if (((x>=powLightOnMinuteUp[0]) && (x<=powLightOnMinuteUp[2]))  && ((y>=powLightOnMinuteUp[1]) && (y<=powLightOnMinuteUp[3]))) // homebutton
        {waitForIt(powLightOnMinuteUp[0], powLightOnMinuteUp[1], powLightOnMinuteUp[2], powLightOnMinuteUp[3]);
        if ((powLightOnMinute>=59)&&(powLightOnMinute<=250)){powLightOnMinute=0;}
        else {powLightOnMinute++;}
         UpdatePowerSchedScreen();
        }
        else if (((x>=powLightOnMinuteDown[0]) && (x<=powLightOnMinuteDown[2]))  && ((y>=powLightOnMinuteDown[1]) && (y<=powLightOnMinuteDown[3]))) // homebutton
        {waitForIt(powLightOnMinuteDown[0], powLightOnMinuteDown[1], powLightOnMinuteDown[2], powLightOnMinuteDown[3]);
        powLightOnMinute--;
        if (powLightOnMinute>=230){powLightOnMinute=59;}
        UpdatePowerSchedScreen();
        }
        ...
        if ((powLightOffHour>=23)&&(powLightOffHour<=250)){powLightOffHour=0;}
        else {powLightOffHour++;}
         UpdatePowerSchedScreen();
        }
        ...
        powLightOffHour--;
        if (powLightOffHour>=230){powLightOffHour=23;}
        UpdatePowerSchedScreen();
        }
         else if (((x>=powLightOffMinuteUp[0]) && (x<=powLightOffMinuteUp[2]))  && ((y>=powLightOffMinuteUp[1]) && (y<=powLightOffMinuteUp[3]))) // homebutton
        {waitForIt(powLightOffMinuteUp[0], powLightOffMinuteUp[1], powLightOffMinuteUp[2], powLightOffMinuteUp[3]);
        if ((powLightOffMinute>=59)&&(powLightOffMinute<=250)){powLightOffMinute=0;}
        else {powLightOffMinute++;}
         UpdatePowerSchedScreen();
        }
        else if (((x>=powLightOffMinuteDown[0]) && (x<=powLightOffMinuteDown[2]))  && ((y>=powLightOffMinuteDown[1]) && (y<=powLightOffMinuteDown[3]))) // homebutton
        {waitForIt(powLightOffMinuteDown[0], powLightOffMinuteDown[1], powLightOffMinuteDown[2], powLightOffMinuteDown[3]);
        powLightOffMinute--;
        if (powLightOffMinute>=230){powLightOffMinute=59;}
        UpdatePowerSchedScreen();
        }        
        else if (((x>=powCo2OnHourUp[0]) && (x<=powCo2OnHourUp[2]))  && ((y>=powCo2OnHourUp[1]) && (y<=powCo2OnHourUp[3]))) // homebutton
        {waitForIt(powCo2OnHourUp[0], powCo2OnHourUp[1], powCo2OnHourUp[2], powCo2OnHourUp[3]);
        if ((powCo2OnHour>=23)&&(powCo2OnHour<=250)){powCo2OnHour=0;}
        else {powCo2OnHour++;}
         UpdatePowerSchedScreen();
        }
        else if (((x>=powCo2OnHourDown[0]) && (x<=powCo2OnHourDown[2]))  && ((y>=powCo2OnHourDown[1]) && (y<=powCo2OnHourDown[3]))) // homebutton
        {waitForIt(powCo2OnHourDown[0], powCo2OnHourDown[1], powCo2OnHourDown[2], powCo2OnHourDown[3]);
        powCo2OnHour--;
        if (powCo2OnHour>=230){powCo2OnHour=23;}
        UpdatePowerSchedScreen();
        }
         else if (((x>=powCo2OnMinuteUp[0]) && (x<=powCo2OnMinuteUp[2]))  && ((y>=powCo2OnMinuteUp[1]) && (y<=powCo2OnMinuteUp[3]))) // homebutton
        {waitForIt(powCo2OnMinuteUp[0], powCo2OnMinuteUp[1], powCo2OnMinuteUp[2], powCo2OnMinuteUp[3]);
        if ((powCo2OnMinute>=59)&&(powCo2OnMinute<=250)){powCo2OnMinute=0;}
        else {powCo2OnMinute++;}
         UpdatePowerSchedScreen();
        }
        else if (((x>=powCo2OnMinuteDown[0]) && (x<=powCo2OnMinuteDown[2]))  && ((y>=powCo2OnMinuteDown[1]) && (y<=powCo2OnMinuteDown[3]))) // homebutton
        {waitForIt(powCo2OnMinuteDown[0], powCo2OnMinuteDown[1], powCo2OnMinuteDown[2], powCo2OnMinuteDown[3]);
        powCo2OnMinute--;
        if (powCo2OnMinute>=230){powCo2OnMinute=59;}
        UpdatePowerSchedScreen();
        }
        ...
        if ((powCo2OffHour>=23)&&(powCo2OffHour<=250)){powCo2OffHour=0;}
        else {powCo2OffHour++;}
         UpdatePowerSchedScreen();
        }
        ...
        powCo2OffHour--;
        if (powCo2OffHour>=230){powCo2OffHour=23;}
        UpdatePowerSchedScreen();
        }
         else if (((x>=powCo2OffMinuteUp[0]) && (x<=powCo2OffMinuteUp[2]))  && ((y>=powCo2OffMinuteUp[1]) && (y<=powCo2OffMinuteUp[3]))) // homebutton
        {waitForIt(powCo2OffMinuteUp[0], powCo2OffMinuteUp[1], powCo2OffMinuteUp[2], powCo2OffMinuteUp[3]);
        if ((powCo2OffMinute>=59)&&(powCo2OffMinute<=250)){powCo2OffMinute=0;}
        else {powCo2OffMinute++;}
         UpdatePowerSchedScreen();
        }
        else if (((x>=powCo2OffMinuteDown[0]) && (x<=powCo2OffMinuteDown[2]))  && ((y>=powCo2OffMinuteDown[1]) && (y<=powCo2OffMinuteDown[3]))) // homebutton
        {waitForIt(powCo2OffMinuteDown[0], powCo2OffMinuteDown[1], powCo2OffMinuteDown[2], powCo2OffMinuteDown[3]);
        powCo2OffMinute--;
        if (powCo2OffMinute>=230){powCo2OffMinute=59;}
        UpdatePowerSchedScreen();
        }
        else if (((x>=SetPowerSchedCord[0]) && (x<=SetPowerSchedCord[2]))  && ((y>=SetPowerSchedCord[1]) && (y<=SetPowerSchedCord[3]))) // homebutton
        {waitForIt(SetPowerSchedCord[0], SetPowerSchedCord[1], SetPowerSchedCord[2], SetPowerSchedCord[3]);
       ...
       case 13: //testscreen
        ...
        {waitForIt(powLightOnHourUp[0], powLightOnHourUp[1], powLightOnHourUp[2], powLightOnHourUp[3]);
        if ((screenOnHour>=23)&&(screenOnHour<=250)){screenOnHour=0;}
        else {screenOnHour++;}
         UpdateScreenScreen();
        }
        else if (((x>=powLightOnHourDown[0]) && (x<=powLightOnHourDown[2]))  && ((y>=powLightOnHourDown[1]) && (y<=powLightOnHourDown[3]))) // homebutton
        {waitForIt(powLightOnHourDown[0], powLightOnHourDown[1], powLightOnHourDown[2], powLightOnHourDown[3]);
        screenOnHour--;
        if (screenOnHour>=230){screenOnHour=23;}
        UpdateScreenScreen();
        }
         else if (((x>=powLightOnMinuteUp[0]) && (x<=powLightOnMinuteUp[2]))  && ((y>=powLightOnMinuteUp[1]) && (y<=powLightOnMinuteUp[3]))) // homebutton
        {waitForIt(powLightOnMinuteUp[0], powLightOnMinuteUp[1], powLightOnMinuteUp[2], powLightOnMinuteUp[3]);
        if ((screenOnMinute>=59)&&(screenOnMinute<=250)){screenOnMinute=0;}
        else {screenOnMinute++;}
         UpdateScreenScreen();
        }
        else if (((x>=powLightOnMinuteDown[0]) && (x<=powLightOnMinuteDown[2]))  && ((y>=powLightOnMinuteDown[1]) && (y<=powLightOnMinuteDown[3]))) // homebutton
        {waitForIt(powLightOnMinuteDown[0], powLightOnMinuteDown[1], powLightOnMinuteDown[2], powLightOnMinuteDown[3]);
        screenOnMinute--;
        if (screenOnMinute>=230){screenOnMinute=59;}
        UpdateScreenScreen();
        }
        else if (((x>=powLightOffHourUp[0]) && (x<=powLightOffHourUp[2]))  && ((y>=powLightOffHourUp[1]) && (y<=powLightOffHourUp[3]))) // homebutton
        {waitForIt(powLightOffHourUp[0], powLightOffHourUp[1], powLightOffHourUp[2], powLightOffHourUp[3]);
        if ((screenOffHour>=23)&&(screenOffHour<=250)){screenOffHour=0;}
        else {screenOffHour++;}
         UpdateScreenScreen();
        }
        else if (((x>=powLightOffHourDown[0]) && (x<=powLightOffHourDown[2]))  && ((y>=powLightOffHourDown[1]) && (y<=powLightOffHourDown[3]))) // homebutton
        {waitForIt(powLightOffHourDown[0], powLightOffHourDown[1], powLightOffHourDown[2], powLightOffHourDown[3]);
        screenOffHour--;
        if (screenOffHour>=230){screenOffHour=23;}
        UpdateScreenScreen();
        }
         else if (((x>=powLightOffMinuteUp[0]) && (x<=powLightOffMinuteUp[2]))  && ((y>=powLightOffMinuteUp[1]) && (y<=powLightOffMinuteUp[3]))) // homebutton
        {waitForIt(powLightOffMinuteUp[0], powLightOffMinuteUp[1], powLightOffMinuteUp[2], powLightOffMinuteUp[3]);
        if ((screenOffMinute>=59)&&(screenOffMinute<=250)){screenOffMinute=0;}
        else {screenOffMinute++;}
         UpdateScreenScreen();
        }
        else if (((x>=powLightOffMinuteDown[0]) && (x<=powLightOffMinuteDown[2]))  && ((y>=powLightOffMinuteDown[1]) && (y<=powLightOffMinuteDown[3]))) // homebutton
        {waitForIt(powLightOffMinuteDown[0], powLightOffMinuteDown[1], powLightOffMinuteDown[2], powLightOffMinuteDown[3]);
        screenOffMinute--;
        if (screenOffMinute>=230){screenOffMinute=59;}
        UpdateScreenScreen();
        }        

         else if (((x>=powCo2OnMinuteUp[0]) && (x<=powCo2OnMinuteUp[2]))  && ((y>=powCo2OnMinuteUp[1]) && (y<=powCo2OnMinuteUp[3]))) // homebutton
        {waitForIt(powCo2OnMinuteUp[0], powCo2OnMinuteUp[1], powCo2OnMinuteUp[2], powCo2OnMinuteUp[3]);
        if ((standByMinutes>=59)&&(standByMinutes<=250)){standByMinutes=0;}
        else {standByMinutes++;}
         UpdateScreenScreen();
        }
        else if (((x>=powCo2OnMinuteDown[0]) && (x<=powCo2OnMinuteDown[2]))  && ((y>=powCo2OnMinuteDown[1]) && (y<=powCo2OnMinuteDown[3]))) // homebutton
        {waitForIt(powCo2OnMinuteDown[0], powCo2OnMinuteDown[1], powCo2OnMinuteDown[2], powCo2OnMinuteDown[3]);
        standByMinutes--;
        if (standByMinutes>=230){standByMinutes=59;}
        UpdateScreenScreen();
        }
         else if (((x>=powCo2OffMinuteUp[0]) && (x<=powCo2OffMinuteUp[2]))  && ((y>=powCo2OffMinuteUp[1]) && (y<=powCo2OffMinuteUp[3]))) // homebutton
        {waitForIt(powCo2OffMinuteUp[0], powCo2OffMinuteUp[1], powCo2OffMinuteUp[2], powCo2OffMinuteUp[3]);
